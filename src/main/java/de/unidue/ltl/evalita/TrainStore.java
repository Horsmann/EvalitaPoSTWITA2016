    ...
    implements Constants
{
        ...
        throws Exception
    {
        ...
        TrainStore experiment = new TrainStore();
        ...
        throws Exception
    {
        ...
        Dimension<TcFeatureSet> features = Dimension.create(DIM_FEATURE_SET,
                Features.getFeatures(brownCluster, posDict, namelists));

        Dimension<List<String>> dimClassificationArgs = Dimension.create(DIM_CLASSIFICATION_ARGS,
                asList(new String[] { CRFSuiteAdapter.ALGORITHM_AVERAGED_PERCEPTRON, "-p",
    ...
    protected void validation(ParameterSpace pSpace)
        throws Exception
    {
        ExperimentSaveModel batch = new ExperimentSaveModel("evalita", CRFSuiteAdapter.class,
                new File(System.getProperty("user.home") + "/Desktop/evalitaModel"));
